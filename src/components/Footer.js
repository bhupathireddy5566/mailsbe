    ...
    <footer className={styles.footer}>
      ...
      <div className={styles.widgetsDiv}>
        ...
        <div className={styles.widget1Div}>
          ...
          <button className={styles.career} onClick={() => window.location.href="https://github.com/aashishpanthi/mailsbe"}>Career</button>
          <button className={styles.worksA} onClick={() => window.location.href="https://github.com/aashishpanthi/mailsbe"}>Works</button>
          <button className={styles.features} onClick={() => window.location.href="https://github.com/aashishpanthi/mailsbe"}>Features</button>
        </div>
